...
# Load data
df = pd.read_csv("data/hurricane_eye_radius_database.csv")
...
# Save results
df.to_csv("outputs/hurricane_eye_wall_results_from_database.csv", index=False)
...
plt.tight_layout()
plt.savefig("outputs/eye_pred_vs_obs_f_based.png")
...
plt.tight_layout()
plt.savefig("outputs/eye_percent_error_hist_f_based.png")
