...
for col, (func, label) in enumerate(objects):
    ...
    ax2d.set_xlabel('x (along cylinder axis)', fontsize=8)
    ax2d.set_ylabel('θ (degrees around cylinder)', fontsize=8)
    ...
    cb.set_label('Relative flux', fontsize=7)
...
plt.tight_layout()
plt.savefig('/mnt/user-data/outputs/shroud_inverse_square_model.png',
